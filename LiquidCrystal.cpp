...
// display initialized by this library as follows:
//
// 1. Display clear
// 2. Function set:
...
void LiquidCrystal::begin(uint8_t cols, uint8_t lines, uint8_t dotsize) {
  ...
  // according to datasheet, we need at least 500ms after power rises above 2.7V
  ...
  digitalWrite(_enable_pin, LOW);
	...
	delayMicroseconds(10000);  // wait more than 4.1ms
...
void LiquidCrystal::pulseEnable(void) {
  ...
  delayMicroseconds(20);    // enable pulse must be >450ns
  digitalWrite(_enable_pin, LOW);
  delayMicroseconds(10000);   // commands need > 37us to settle
}
